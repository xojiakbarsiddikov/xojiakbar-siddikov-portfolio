...
import School2 from '../uikit/Media-School2.vue'
...
onMounted(() => {
    productService.getProductsSchool().then((data) => (products.value = data));
});
...
<template>
    <div class="grid p-fluid">
        <div class="col-12">
            <div class="card">
                <h4 style="margin: 0;" class="school-texts-wrapper">SCHOOL CERTIFICATES:<span class="blue-color" style="margin-left: 5px;">(Primary-High School)</span></h4>
                <Carousel :value="products" :numVisible="3" :numScroll="3" :circular="false" :responsiveOptions="carouselResponsiveOptions" class="carousel2 mt-3">
