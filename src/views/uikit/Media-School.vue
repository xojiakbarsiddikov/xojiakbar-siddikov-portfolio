...
<template>
    <div class="grid p-fluid">
        <div class="col-12">
            <div class="card">
                <h5>SCHOOL CERTIFICATES:<span class="blue-color" style="margin-left: 5px;">(Primary-High School)</span></h5>
                <Carousel :value="products" :numVisible="3" :numScroll="3" :circular="false" :responsiveOptions="carouselResponsiveOptions" class="carousel2">
